...
Legendre, L. J., and J. A. Clarke. Shifts in eggshell thickness are related to changes in locomotor ecology in dinosaurs. Evolution.
...
OU<-gls(log(Egg_mass)~log(Body_mass), data=datamass, correlation=corMartins(1, phy=treemass, fixed=T), weights=varFixed(~Wm), method="ML")
